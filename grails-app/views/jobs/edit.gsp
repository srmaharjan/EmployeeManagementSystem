...
<div class="row-fluid">
    ...
    <div class="span9">
        ...
        <g:form method="post"  action="update" class="form-horizontal style1" name="${jobsInstance?.id}">
        <g:hiddenField name="id" value="${jobsInstance?.id}" />
        <g:hiddenField name="version" value="${jobsInstance?.version}" />
        <fieldset class="form">
            <g:render template="form"/>
        </fieldset>
        <fieldset class="buttons">
            <button type="submit" class="btn btn-primary button" formaction="update">
