...
<div class="row-fluid">
    ...
    <div class="span9">
        ...
        <g:form method="post"  action="update" class="form-horizontal style1" name="${applicationProcessInstance?.id}">
        <g:hiddenField name="id" value="${applicationProcessInstance?.id}" />
        <g:hiddenField name="version" value="${applicationProcessInstance?.version}" />
        <fieldset class="form">
