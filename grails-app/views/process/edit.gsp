...
<div class="row-fluid">
      ...
      <div class="span9">
            ...
            <g:form method="post"  action="update" class="form-horizontal style1" name="${processInstance?.id}">
...
<jqvalui:renderValidationScript for="com.ligontech.Process" />
</body>
</html>
