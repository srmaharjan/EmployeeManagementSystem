...
class AddressController {
    ...
    def list(Integer max) {
        ...
        [addressInstanceList: NepAddress.list(params), addressInstanceTotal: NepAddress.count()]
    }

    def create() {
        [addressInstance: new NepAddress(params)]
    }

    def save() {
        def addressInstance = new NepAddress(params)
    ...
    def show(Long id) {
        def addressInstance = NepAddress.get(id)
        if (!addressInstance) {
